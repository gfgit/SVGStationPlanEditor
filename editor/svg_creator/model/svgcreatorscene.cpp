    ...
    , m_bkItem(nullptr)
{
    ...
    //m_scene->setBackgroundBrush(Qt::white); //FIXME: draw only page box
}

void SvgCreatorScene::clear()
{
...
bool SvgCreatorScene::loadStationXML(QIODevice *dev)
{
    ...
    m_bkItem = m_scene->addRect(sceneRect, QPen(Qt::black, 2), Qt::white);
    m_bkItem->setZValue(-10); //Put in background
...
void SvgCreatorScene::onSelectionChanged() {}

PlatformItem SvgCreatorScene::createPlatform(const QString &name, int num)
{
...
void SvgCreatorScene::movePlatformTo(PlatformItem &item, const QPointF &pos)
{
...
GateItem SvgCreatorScene::createGate(QChar name, int outTrackCnt)
{
...
void SvgCreatorScene::moveGateTo(GateItem &item, const QPointF &pos)
{
...
void SvgCreatorScene::createStLabel()
{
